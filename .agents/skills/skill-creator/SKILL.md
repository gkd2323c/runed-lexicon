...
node .agents/skills/skill-creator/scripts/check_env.mjs --capability package-skill
node .agents/skills/skill-creator/scripts/check_env.mjs --capability run-loop
```
