...
compatibility: Requires Python 3.10+ and the skyrim-mod-translator project layout with mods/, dictionary/, and xEdit context JSON. Uses only the Python standard library and does not require network access.
metadata:
  version: "0.2.1"
---
