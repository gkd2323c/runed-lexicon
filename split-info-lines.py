...
doc = json.load(open('.work/Druadach-mutagen-dialogue.json', encoding='utf-8'))
...
json.dump(out_lines, open('.work/Druadach-info-split.json', 'w', encoding='utf-8'),
          ensure_ascii=False)
json.dump(unlinked, open('.work/Druadach-info-unlinked.json', 'w', encoding='utf-8'))
